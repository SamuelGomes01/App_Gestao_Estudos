...
const CACHE = 'estudos-v165-largada-variada';
...
const ESTATICOS = [
  ...
  './js/frases.js',
  './css/styles.css?v=20260907-largada-variada',
  './js/domain.js?v=20260907-largada-variada',
  './js/store.js?v=20260907-largada-variada',
  './js/sync.js?v=20260718h-seguranca-escala',
  './js/remote-state.js?v=20260718h-seguranca-escala',
  './js/firebase-sync.js?v=20260907-largada-variada',
  ...
  './js/app.js?v=20260907-largada-variada',
  './icons/icone.svg',
  './icons/icone-192.png',
  './icons/icone-512.png'
];
