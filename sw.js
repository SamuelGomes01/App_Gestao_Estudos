...
const CACHE = 'estudos-v168-reta-final-opt-in';
...
const ESTATICOS = [
  ...
  './js/frases.js',
  './css/styles.css?v=20260907d-reta-final-opt-in',
  './js/domain.js?v=20260907d-reta-final-opt-in',
  './js/store.js?v=20260907d-reta-final-opt-in',
  './js/sync.js?v=20260718h-seguranca-escala',
  './js/remote-state.js?v=20260718h-seguranca-escala',
  './js/firebase-sync.js?v=20260907d-reta-final-opt-in',
  ...
  './js/app.js?v=20260907d-reta-final-opt-in',
  './icons/icone.svg',
  './icons/icone-192.png',
  './icons/icone-512.png'
];
