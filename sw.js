...
const CACHE = 'estudos-v167-intercala-dia';
...
const ESTATICOS = [
  ...
  './js/frases.js',
  './css/styles.css?v=20260907c-intercala-dia',
  './js/domain.js?v=20260907c-intercala-dia',
  './js/store.js?v=20260907c-intercala-dia',
  './js/sync.js?v=20260718h-seguranca-escala',
  './js/remote-state.js?v=20260718h-seguranca-escala',
  './js/firebase-sync.js?v=20260907c-intercala-dia',
  ...
  './js/app.js?v=20260907c-intercala-dia',
  './icons/icone.svg',
  './icons/icone-192.png',
  './icons/icone-512.png'
];
