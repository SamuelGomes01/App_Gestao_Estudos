...
const CACHE = 'estudos-v166-ordem-agenda';
...
const ESTATICOS = [
  ...
  './js/frases.js',
  './css/styles.css?v=20260907b-ordem-agenda',
  './js/domain.js?v=20260907b-ordem-agenda',
  './js/store.js?v=20260907b-ordem-agenda',
  './js/sync.js?v=20260718h-seguranca-escala',
  './js/remote-state.js?v=20260718h-seguranca-escala',
  './js/firebase-sync.js?v=20260907b-ordem-agenda',
  ...
  './js/app.js?v=20260907b-ordem-agenda',
  './icons/icone.svg',
  './icons/icone-192.png',
  './icons/icone-512.png'
];
